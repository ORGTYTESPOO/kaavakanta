...
//
//    
//    public HistoriaJPA(int id, String kaavatunnus, String kaavanimi, String lisatieto, String hankkeenkuvaus, String kaavatyyppi, String suunnittelualue, Date aikaleima) {
//        this.id = id;
